...
public class MemberController {
    ...
    @PostMapping
    public ResponseEntity<ResponseFormat<Member>> save(@RequestBody MemberDto memberDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ResponseFormat<Member>> update(@RequestBody MemberDto memberDto, @PathVariable UUID id) {
        return ResponseEntity.ok(responseFormat.format(
